...
function bindEvents(){
    ...
    document
        .getElementById("at-image-file")
        .onchange=loadImage;

    document
        .getElementById("btn-at-save")
        .onclick=saveData;
}
...
function loadImage(e){
    ...
    reader.onload=()=>{
        ...
        const img=
            document.getElementById("at-preview");
...
async function saveData(){
    ...
    const name=
        document
            .getElementById("at-name")
            .value
            .trim();

    const address=
        document
            .getElementById("at-address")
            .value
            .trim();

    const map=
        document
            .getElementById("at-map")
            .value
            .trim();

    const video=
        document
            .getElementById("at-video")
            .value
            .trim();
